...
class ConfirmedEmail extends React.Component {
                ...
                <View style={{ flex: 1, }}>
                    <ImageBackground source={require('./../../components/Images/background.jpg')}
                        ...
                        <View style={{ marginTop: 20, alignSelf: 'center' }}>
                            <Text style={{ color: '#fff' }}>Email Confirmation Sent!</Text>
                        </View>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                onPress={()=> Actions.AccountVerified()}
                                style={styles.next}>
                                <Text style={{ color: '#fff', fontSize: 14, }}>Proceed</Text>
                            </TouchableOpacity>
                        </View>
                    </ImageBackground>
                </View>
